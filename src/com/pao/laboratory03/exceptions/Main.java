...
public class Main {
    ...
    public static void validateAge(int age) {
        if (age < 0 || age > 150) {
            throw new InvalidAgeException("InvalidAgeException: Varsta " + age + " nu este valida (0-150)");
        }
    }

    public static void addToList(List<String> list, String name) {
        if (list.contains(name)) {
            throw new DuplicateEntryException("DuplicateEntryException: '" + name + "' exista deja in list");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            addToList(List.of("Ana", "Maria"), "Ana");
        ...
        try {
            ...
            System.out.println("General runtime exception: " + e.getMessage());
        }
